...
export function resolvePreviewAsset(
  ...
  if (category === 'necklace') {
    ...
    if (mappedStyle) return { src: `/images/Necklace/necklace-${isGold ? 'gold-' : ''}style-${mappedStyle}.png`, match: 'exact', alt: `${mappedStyle} necklace` };
    if (mappedGenericShape) return { src: `/images/Necklace/necklace-${isGold ? 'gold-' : ''}${mappedGenericShape}.png`, match: 'exact', alt: `${mappedGenericShape} necklace` };
  ...
  if (category === 'bracelet') {
    ...
    if (mappedStyle) return { src: `/images/Bracelet/bracelet-${isGold ? 'gold-' : ''}style-${mappedStyle}.png`, match: 'exact', alt: `${mappedStyle} bracelet` };
    if (mappedGenericShape) {
      let shapeName = mappedGenericShape;
      if (isGold && shapeName === 'emerald') shapeName = 'emeraldd';
  ...
  if (category === 'bangle') {
    ...
    if (mappedStyle) return { src: `/images/Bangle/bangle-${isGold ? 'gold-' : ''}style-${mappedStyle}.png`, match: 'exact', alt: `${mappedStyle} bangle` };
    if (mappedGenericShape) return { src: `/images/Bangle/bangle-${isGold ? 'gold-' : ''}${mappedGenericShape}.png`, match: 'exact', alt: `${mappedGenericShape} bangle` };
  ...
  if (category === 'brooch') {
    ...
    if (mappedStyle) {
      if (isGold) {
        if (mappedStyle === 'bow-ribbonn') return { src: '/images/Brooch/brooch-gold-style-bow-ribbon.png', match: 'exact', alt: 'Gold bow ribbon brooch' };
    ...
    if (mappedGenericShape) return { src: `/images/Brooch/brooch-${isGold ? 'gold-' : ''}${mappedGenericShape}.png`, match: 'exact', alt: `${mappedGenericShape} brooch` };
    if (isGold) return { src: '/images/Brooch/brooch-style-gold-floral.png', match: 'fallback', alt: 'Gold brooch preview' };
  ...
  if (category === 'anklet') {
    ...
    if (mappedStyle) return { src: `/images/Angklet/angklet-${isGold ? 'gold-' : ''}style-${mappedStyle}.png`, match: 'exact', alt: `${mappedStyle} anklet` };
    if (mappedGenericShape) return { src: `/images/Angklet/angklet-${isGold ? 'gold-' : ''}${mappedGenericShape}.png`, match: 'exact', alt: `${mappedGenericShape} anklet` };
