...
export interface ConfigStep {
  ...
  name: string;
  nameCn: string;
  type: 'swatch' | 'image-swatch' | 'dropdown' | 'text' | 'card-grid';
  options: CustomOption[];
  description?: string;
  descriptionCn?: string;
  condition?: (selections: Record<string, string>) => boolean;
  displayStep?: number;
  guide?: {
    images?: string[];
    text?: string;
...
const interchangeabilityStep: ConfigStep = {
...
// ── STEP 4a: Stone Shape ──
const stoneShapeStep: ConfigStep = {
  id: 'stone-shape',
  name: 'Stone Shape',
  nameCn: '宝石形状',
  type: 'card-grid',
...
// ── STEP 4b: Stone Size ──
const stoneSizeStep: ConfigStep = {
  id: 'stone-size',
  name: 'Stone Size',
  nameCn: '宝石大小',
  type: 'card-grid',
...
// ── STEP 5: Side Stone 1 ──
const sideStoneStep: ConfigStep = {
  id: 'side-stones',
  name: 'Side Stone 1',
  nameCn: '副石 1',
  type: 'card-grid',
...
const sideStoneShapeStep: ConfigStep = {
  id: 'side-stone-shape',
...
const addSecondSideStoneStep: ConfigStep = {
...
const sideStone2Step: ConfigStep = {
  id: 'side-stone-2',
  name: 'Side Stone 2',
  nameCn: '副石 2',
  type: 'card-grid',
...
const sideStone2ShapeStep: ConfigStep = {
...
// ── 8a-0: Ring Sub-type ──
const ringSubTypeStep: ConfigStep = {
  id: 'ring-sub-type',
  name: 'Ring Style',
  nameCn: '戒指风格',
  type: 'card-grid',
...
const ringBandProfileStep: ConfigStep = {
...
// ── 8a-2: Band Thickness ──
const ringBandThicknessStep: ConfigStep = {
...
const ringSurfaceFinishStep: ConfigStep = {
...
const ringMainSettingStep: ConfigStep = {
...
const ringSideSettingStep: ConfigStep = {
...
const studSettingStep: ConfigStep = {
  id: 'stud-setting',
...
const studBackingStep: ConfigStep = {
  id: 'stud-backing',
...
// ── 8b-3: Backing Size ──
const studBackingSizeStep: ConfigStep = {
...
const danglingDropStyleStep: ConfigStep = {
...
const danglingSettingStep: ConfigStep = {
  id: 'dangling-setting',
  name: 'Main Stone Setting',
  nameCn: '主石镶嵌',
  type: 'card-grid',
...
const danglingSideSettingStep: ConfigStep = {
...
const danglingConnectionStep: ConfigStep = {
...
const pendantStyleStep: ConfigStep = {
  id: 'pendant-style',
...
const pendantSettingStep: ConfigStep = {
  id: 'pendant-setting',
  name: 'Main Stone Setting',
  nameCn: '主石镶嵌',
  type: 'card-grid',
...
const pendantSideSettingStep: ConfigStep = {
...
// ── 8d-4: Bail Style ──
const pendantBailStep: ConfigStep = {
  id: 'pendant-bail',
  name: 'Bail Style',
  nameCn: '挂扣风格',
  type: 'card-grid',
...
// ── 8d-5: Chain Style ──
const pendantChainStep: ConfigStep = {
  id: 'pendant-chain',
  name: 'Chain Style',
  nameCn: '链条风格',
  type: 'card-grid',
...
// ── 8d-6: Chain Length ──
const pendantLengthStep: ConfigStep = {
  id: 'pendant-length',
  name: 'Chain Length',
  nameCn: '链条长度',
  type: 'card-grid',
...
const pendantAdjustableStep: ConfigStep = {
...
const necklaceStyleStep: ConfigStep = {
  id: 'necklace-style',
...
const necklaceChainStyleStep: ConfigStep = {
...
const necklaceStonePlacementStep: ConfigStep = {
...
const necklaceSettingStyleStep: ConfigStep = {
...
// ── 8e-5: Clasp Style ──
const necklaceClaspStep: ConfigStep = {
  id: 'necklace-clasp',
  name: 'Clasp Style',
  nameCn: '扣环风格',
  type: 'card-grid',
...
// ── 8e-6: Chain Length ──
const necklaceLengthStep: ConfigStep = {
  id: 'necklace-length',
  name: 'Chain Length',
  nameCn: '链条长度',
  type: 'card-grid',
...
// ── 8f-1: Bracelet Style ──
const braceletStyleStep: ConfigStep = {
  id: 'bracelet-style',
  name: 'Bracelet Style',
  nameCn: '手链风格',
  type: 'card-grid',
...
const braceletChainStep: ConfigStep = {
  id: 'bracelet-chain',
...
const braceletSettingStep: ConfigStep = {
  id: 'bracelet-setting',
...
// ── 8f-4: Clasp Style ──
const braceletClaspStep: ConfigStep = {
  id: 'bracelet-clasp',
  name: 'Clasp Style',
  nameCn: '扣环风格',
  type: 'card-grid',
...
// ── 8f-5: Safety Feature ──
const braceletSafetyStep: ConfigStep = {
  id: 'bracelet-safety',
  name: 'Safety Feature',
  nameCn: '安全功能',
  type: 'card-grid',
...
const braceletLengthStep: ConfigStep = {
  id: 'bracelet-length',
...
const bangleStructureStep: ConfigStep = {
  id: 'bangle-structure',
...
const bangleProfileStep: ConfigStep = {
  id: 'bangle-profile',
...
// ── 8g-3: Width ──
const bangleWidthStep: ConfigStep = {
  id: 'bangle-width',
  name: 'Width',
  nameCn: '宽度',
  type: 'card-grid',
...
const bangleFinishStep: ConfigStep = {
  id: 'bangle-finish',
...
// ── 8g-5: Stone Setting ──
const bangleSettingStep: ConfigStep = {
  id: 'bangle-setting',
  name: 'Stone Setting',
  nameCn: '宝石镶嵌',
  type: 'card-grid',
...
const broochStyleStep: ConfigStep = {
  id: 'brooch-style',
...
// ── 8h-2: Stone Setting ──
const broochSettingStep: ConfigStep = {
  id: 'brooch-setting',
  name: 'Stone Setting',
  nameCn: '宝石镶嵌',
  type: 'card-grid',
...
// ── 8h-3: Dimensionality ──
const broochDimensionalityStep: ConfigStep = {
...
const broochPinStep: ConfigStep = {
  id: 'brooch-pin',
...
// ── 8h-5: Convertibility ──
const broochConvertibilityStep: ConfigStep = {
...
// ── 8h-6: Brooch Size ──
const broochSizeStep: ConfigStep = {
  id: 'brooch-size',
  name: 'Brooch Size',
  nameCn: '胸针尺寸',
  type: 'card-grid',
...
// ── 8i-1: Anklet Style ──
const ankletStyleStep: ConfigStep = {
  id: 'anklet-style',
  name: 'Anklet Style',
  nameCn: '脚链风格',
  type: 'card-grid',
...
// ── 8i-2: Chain Style ──
const ankletChainStep: ConfigStep = {
  id: 'anklet-chain',
  name: 'Chain Style',
  nameCn: '链条风格',
  type: 'card-grid',
...
const ankletCharmStep: ConfigStep = {
  id: 'anklet-charms',
  name: 'Charm Options',
  nameCn: '吊饰选项',
  type: 'card-grid',
...
// ── 8i-4: Clasp Style ──
const ankletClaspStep: ConfigStep = {
  id: 'anklet-clasp',
  name: 'Clasp Style',
  nameCn: '扣环风格',
  type: 'card-grid',
...
// ── 8i-5: Ankle Size ──
const ankletLengthStep: ConfigStep = {
  id: 'anklet-length',
  name: 'Ankle Size',
  nameCn: '脚踝尺寸',
  type: 'card-grid',
...
const ankletToeRingStep: ConfigStep = {
  id: 'anklet-toe-ring',
...
// ── STEP 9: Engraving ──
const engravingStep: ConfigStep = {
  id: 'engraving',
...
// 10-ring: Ring Sizing
const ringSizingStep10: ConfigStep = {
  id: 'ring-sizing-10',
  name: 'Ring Sizing',
  nameCn: '戒指尺寸',
  type: 'card-grid',
...
const braceletSizingStep10: ConfigStep = {
...
const bangleSizingStep10: ConfigStep = {
  id: 'bangle-sizing-10',
  name: 'Bangle Size',
  nameCn: '手镯尺寸',
  type: 'card-grid',
...
const necklaceSizingStep10: ConfigStep = {
...
const ankletSizingStep10: ConfigStep = {
  id: 'anklet-sizing-10',
  name: 'Anklet Size',
  nameCn: '脚链尺寸',
  type: 'card-grid',
...
const noSizingStep10: ConfigStep = {
  id: 'no-sizing-10',
...
export function getActiveSteps(selections: Record<string, string>): ConfigStep[] {
...
export function getStepById(id: string): ConfigStep | undefined {
  return configSteps.find((s) => s.id === id);
}

export function getSizingOptions(categoryValue: string): CustomOption[] {
  const sizeStepMap: Record<string, string> = {
    ring: 'ring-size',
